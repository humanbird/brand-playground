...
export type Screen = {
  ...
  path: string
  /** true for a prototype's index.tsx. */
  isIndex: boolean
...
export type Prototype = {
  ...
  isReference: boolean
  /** true when no index.tsx exists; the first screen is then the entry screen. */
  missingIndex: boolean
}

type ScreenModule = { default?: ComponentType; meta?: PrototypeMeta }
